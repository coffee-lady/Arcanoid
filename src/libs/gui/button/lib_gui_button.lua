...
function GuiButtonLib:animate_button_click_pressed(button, blackout, delta_scale, duration)
...
function GuiButtonLib:animate_button_click_released(button, duration)
...
function GuiButtonLib:animate_button_click(action, button, blackout, delta_scale, duration)
    local btn_data = self[gui.get_id(button)]
