...
local YandexRewardedAdsAdapter = {}

function YandexRewardedAdsAdapter:init(delay, file, key_timer, player_data_storage)
...
function YandexRewardedAdsAdapter:show(callbacks)
...
function YandexRewardedAdsAdapter:show_on_reward(callbacks)
...
return YandexRewardedAdsAdapter
