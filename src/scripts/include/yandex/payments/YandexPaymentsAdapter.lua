...
local YandexPaymentsAdapter = {}

function YandexPaymentsAdapter:init()
    Async(function(done)
        yagames.payments_init(nil, function(_, err)
...
function YandexPaymentsAdapter:purchase_async(id)
...
function YandexPaymentsAdapter:get_purchases_async()
    return Async(function(done)
        yagames.payments_get_purchases(function(_, err, result)
...
function YandexPaymentsAdapter:_process_purchases(purchases)
    local result = {}
...
function YandexPaymentsAdapter:get_catalog_async()
    return Async(function(done)
        yagames.payments_get_catalog(function(_, err, result)
...
function YandexPaymentsAdapter:_process_catalog(catalog)
...
function YandexPaymentsAdapter:consume_purchase_async(purchase_token)
    Async(function(done)
        yagames.payments_consume_purchase(purchase_token, function(_, err)
