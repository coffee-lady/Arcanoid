...
local YandexFeedbackAdapter = {}

function YandexFeedbackAdapter:is_reviewable()
    return Async(function(done)
        yagames.feedback_can_review(function(_, err, res)
...
function YandexFeedbackAdapter:request_review_async()
    return Async(function(done)
        yagames.feedback_request_review(function(_, err, result)
