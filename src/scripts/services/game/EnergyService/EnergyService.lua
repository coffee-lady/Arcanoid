...
function EnergyService:buy_life()
    return self:can_change_count(-EnergyConfig.life_cost)
end

function EnergyService:restart_level()
    return self:can_change_count(-EnergyConfig.restart_cost)
end

function EnergyService:win_level()
    self:can_change_count(EnergyConfig.level_reward)
end
