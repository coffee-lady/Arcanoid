--- @class StoreFindProductUseCase
local StoreFindProductUseCase = {}

function StoreFindProductUseCase:find_product(product_id, shop_catalog)
...
return StoreFindProductUseCase
