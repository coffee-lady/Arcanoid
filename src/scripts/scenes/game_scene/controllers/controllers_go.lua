...
local BlocksController = require('src.scripts.scenes.game_scene.controllers.BlocksController.BlocksController')
...
local ControllersGO = {BallsController, PlatformController, BlocksController, WallsController, LosingZoneController}
