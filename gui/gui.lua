...
GUI.ThemeObject = require('gui.core.theme_objects.theme_object.theme_object')
GUI.StaticThemeObject = require('gui.core.theme_objects.static_theme_object.static_theme_object')
GUI.ThemeMap = require('gui.core.theme_objects.theme_map.theme_map')
